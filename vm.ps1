...
$adminPassword = "P@ssw0rd1234!"  # Ensure you follow Azure's password complexity requirements
...
$subnetConfig = Add-AzVirtualNetworkSubnetConfig -Name "$vmName-subnet" -AddressPrefix "10.0.0.0/24" -VirtualNetwork $vnet
